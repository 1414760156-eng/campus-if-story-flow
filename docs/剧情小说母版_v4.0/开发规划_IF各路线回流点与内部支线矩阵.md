...
父池分发窗口：第三幕父池一共有三次社团 / 活动选择机会。第一次所有方向都可选；第二次可以维持第一次方向，也可以去别的方向试试；第三次只能选择坚持第一个、坚持第二个、两个都要、两个都不要。两个都要自动进入压力模式，两个都不要进入宿舍线。未胜出的方向只能成为软照面、群消息、后续台词或关系变量，不能再开完整路线。
